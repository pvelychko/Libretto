			...
			<div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-1 text-center">
				...
				<div class="dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
						<li>
							<a href="/user/${currentUser.id}">All Categories</a>
						</li>
						<li role="separator" class="divider"></li>
						<#list categories as category>
							<li>
								<a href="/user/${currentUser.id}/category/${category.id}">${category.name}</a>
							</li>
						</#list>
					</ul>
				</div>
			...
			<div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-2 text-center">
				...
				<div class="dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
						<li>
							<#if currentCategory??>
								<a href="/user/${currentUser.id}/category/${currentCategory.id}">All Titles</a>
							<#else>
								<a href="/user/${currentUser.id}">All Titles</a>
							</#if>
						</li>
						<li role="separator" class="divider"></li>
						<#list books as book>
							<li>
								<a href="/user/${currentUser.id}/book/${book.id}">${book.name}</a>
							</li>
						</#list>
					</ul>
				</div>
								        ...
								        <td class="text-center">
								        	<#if book.student??>
								        		<#if book.student.id == currentUser.id>
													<a href="./${currentUser.id}/profile/book/${book.id}/return" class="btn btn-warning">Return</a>
												<#else>
													<#if book.student.id != currentUser.id>
												...
												<#else>
													<a href="./${currentUser.id}/profile/book/${book.id}/borrow" class="btn btn-success">Borrow</a>
											</#if>
										</td>
									</#if>
							    </tr>
